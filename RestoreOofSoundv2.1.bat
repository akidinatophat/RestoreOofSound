...
curl -s https://github.com/akidinatophat/RestoreOofSound/raw/main/ouch.ogg --output C:\Users\%USERNAME%\AppData\Local\Roblox\Versions\%CurrentVersionUpload%\content\sounds\ouch.ogg
color 2
echo Success!
